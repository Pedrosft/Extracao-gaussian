...
class App:
    ...
    def create_main_interface(self):
        ...
        button_selecionar = tk.Button(self.frame, text="Selecionar Moléculas", bg="lightblue", fg="black", command=selecionar_arquivos)
        ...
        button_extrair_inserir = tk.Button(self.frame, text="Extrair Dados", bg="lightblue", fg="black", command=extrair_dados_e_inserir)
